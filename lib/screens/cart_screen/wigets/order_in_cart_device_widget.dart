...
import 'package:cartpayment_test/screens/cart_screen/cart_screen.dart';
import 'package:cartpayment_test/screens/cart_screen/wigets/confirm_delete_widget.dart';
...
class OrderInCartDevice extends StatefulWidget {
  ...
  const OrderInCartDevice(
      {super.key, required this.child}); //required this.child
